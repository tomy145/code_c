 ...
 *  @return 节点首地址
 */
LinkListNode *makeLinkListNode(Student data)
{
...
{
    Student *stu1 = calloc(1, sizeof(Student));
    LinkList *list = (LinkList *)makeLinkListNode(*stu1);
 ...
 *  @return 链表节点
 */
LinkListNode *getLinkListNodeFromLinkList(LinkList **list ,Student *data)
{
...
void printLinkList(LinkList *list)
{
    ...
    while (head != NULL)
    {
        printf("linklist->data --- %s --- 第 - %d - 个节点\n",head->data.name,i);
        head = head->next;
        ++i;
    }
}
